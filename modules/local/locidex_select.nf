...
process LOCIDEX_SELECT {
    ...
    if(params.force_allele_scheme == null && params.locidex.allele_database == null){
    ...
    if(config){ // non null channel should evaluate to true
        ...
        scheme = params.force_allele_scheme // reset the schem path to the passed allele scheme
        paired_p = true
