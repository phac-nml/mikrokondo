...
- staramr
  ...
  - staramr_genome_size_lower_bound: The lower bound for our genome size for the quality metrics. Defaults to 4000000
  - staramr_genome_size_upper_bound : The upper bound for our genome size for the quality metrics. Defaults to 6000000
  ...
  For more information [see starAMR configuration](configuration.md#staramr-parameter-configuration)
...
ECTyper is used to perform _in-silico_ typing of _Escherichia_ and is automatically triggered by the pipeline.
...
Kleborate performs automatic typing of _Kelbsiella_.
...
Performs typing of _Staphylococcus_ species.
...
_In-silico Salmonella_ serotype prediction.
...
_in-silico Shigella_ typing.

> **NOTE:** It is unlikely this subtyper will be triggered as GTDB has merged _E.coli_ and _Shigella_ in an updated sketch. An updated version of ECTyper will be released soon to address the shortfalls of this sketch. If you are relying on _Shigella_ detection add `--run_kraken true` to your command line or update the value in the `.nextflow.config` as Kraken2 (while slower) can still detect _Shigella_.
