...
- Changed the name of process `IDENTIFY_POINTDB` to `IDENTIFY_STARAMR_SPECIES_PARAMS` and the script name `modules/local/select_pointfinder.nf -> modules/local/staramr_species_params.nf`. [PR 220](https://github.com/phac-nml/mikrokondo/pull/220)
...
- Filtered contigs were not being passed to other subsequent processes, resulting in ECTyper, SISTR etc receiving unfiltered contigs. [PR 207](https://github.com/phac-nml/mikrokondo/pull/207)

## [0.9.6] - 2026-01-12

### `Changed`

- Changed default CheckM contamination threshold to 5%. [PR 206](https://github.com/phac-nml/mikrokondo/pull/206)
...
[0.9.7]: https://github.com/phac-nml/mikrokondo/releases/tag/0.9.7
[0.9.6]: https://github.com/phac-nml/mikrokondo/releases/tag/0.9.6
