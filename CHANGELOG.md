...
- Updated `nf-core/fastqc` and `nf-core/custom/dumpsoftwareversions` modules, which also removes `quay.io` container prefix. [PR #198](https://github.com/phac-nml/mikrokondo/pull/198)
